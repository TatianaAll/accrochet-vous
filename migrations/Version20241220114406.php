 ...
 */
final class Version20241220114406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD status_id INT NOT NULL, ADD created_at DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP status_id, DROP created_at');
    }
}
